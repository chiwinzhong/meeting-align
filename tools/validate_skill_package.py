...
REQUIRED_FILES = [
    ...
    SKILL_DIR / "references" / "meeting-type-and-outcome.md",
    SKILL_DIR / "references" / "decision-maturity.md",
    SKILL_DIR / "references" / "strategic-open-questions.md",
    SKILL_DIR / "references" / "role-guardrails.md",
    ...
    ROOT / "examples" / "launch-meeting" / "meeting-type.md",
